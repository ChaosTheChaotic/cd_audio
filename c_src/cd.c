...
char** get_devices() {
  return cdio_get_devices(cdio_os_driver);
}
...
TrackMeta get_track_metadata(char *devicestr, int track) {
    ...
    else meta.title = strdup("Unknown title");
    
    if (artist) meta.artist = artist;
    else meta.artist = strdup("Unknown artist");
    
    if (genre) meta.genre = genre;
    else meta.genre = strdup("Unknown genre");
...
//        const char *type = cdda_track_audiop(drive, track) ? "AUDIO" : "DATA";
//
...
//      printf("Title: %s\n", cdtext_get_const(cdtext, CDTEXT_FIELD_TITLE, track));
//      printf("Genre: %s\n", cdtext_get_const(cdtext, CDTEXT_FIELD_TITLE, track));
//      printf("Performer: %s\n", cdtext_get_const(cdtext, CDTEXT_FIELD_PERFORMER, track));
//      printf("Songwriter: %s\n", cdtext_get_const(cdtext, CDTEXT_FIELD_SONGWRITER, track));
//      printf("Composer: %s\n", cdtext_get_const(cdtext, CDTEXT_FIELD_COMPOSER, track));
//      printf("Arranger: %s\n", cdtext_get_const(cdtext, CDTEXT_FIELD_ARRANGER, track));
